function [profile,VCD] = read_GEOS_CHEM_v3(f_nm,user_lat_index,user_lon_index,i_hour)
...
%UTC = datevec([datetime_str '/' num2str(i_hour-1) '0000'],'yyyymmdd/HHMMSS');
UTC = datevec([num2str(datetime_str) '/000000'],'yyyymmdd/HHMMSS');
UTC(4) = i_hour-1;
...
O3_a = O3(:,i,j,i_hour);% O3 VMR in [ppbv]
