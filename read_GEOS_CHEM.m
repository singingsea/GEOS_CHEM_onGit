function [profile,VCD] = read_GEOS_CHEM(f_nm,PS_a_24hr,T_a47_24hr,PBLH_a,TROPPT_a,user_lat,user_lon)
...
VCD.so2 = so2_vcd;
VCD.hcho = hcho_vcd;
VCD.PBLH = PBLH;% boundary layer height [m]
VCD.TROPPT = TROPPT;% tropause pressure [hPa]
VCD.TROPZ = TROPZ;% trop height [m]

VCD.o3_trop = o3_vcdtrop;% all tropospheric columns are in DU
VCD.no2_trop = no2_vcdtrop;
VCD.so2_trop = so2_vcdtrop;
VCD.hcho_trop = hcho_vcdtrop;
